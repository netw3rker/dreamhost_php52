...
/*   */
#define MYSQL_UNIX_ADDR "/No-MySQL-hostname-was-specified"
...
/* PHP build date */
#define PHP_BUILD_DATE "2016-03-03"

/* hardcode for each of the cross compiler host */
#define PHP_OS "Linux"

/* hardcode for each of the cross compiler host */
#define PHP_UNAME "Linux ds8791 3.2.61-grsec-modsign #1 SMP Tue Aug 12 09:58:26 UTC 2014 x86_64 x86_64 x86_64 GNU/Linux"
